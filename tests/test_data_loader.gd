...
func _run_tests() -> void:
	...
	if template_count == 7:
		print("[PASS] Rift templates loaded: %d (expected 7)" % template_count)
		pass_count += 1
	else:
		print("[FAIL] Rift templates loaded: %d (expected 7)" % template_count)
		fail_count += 1
	...
	if boss_count == 7:
		print("[PASS] Bosses loaded: %d (expected 7)" % boss_count)
		pass_count += 1
	else:
		print("[FAIL] Bosses loaded: %d (expected 7)" % boss_count)
		fail_count += 1
